        ...
        if( have_rows('flexible_dienst') ):
            ...
            while ( have_rows('flexible_dienst') ) : the_row();
                ...
                elseif( get_row_layout() == 'recrubo_block' ): ?>
                    <section class="recrubo-block <?php echo $general_bg_color; if(get_sub_field('positie_afbeelding') == 'links'): echo ' reverse'; endif; ?>">
                        ...
                        <div class="recrubo-block__img">
                            <img src="<?php the_sub_field('blok_afbeelding'); ?>" alt="" srcset="">
                        </div>
                    </section>
                    <?php
